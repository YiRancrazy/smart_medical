...
(2043000000000005001, 2043000000000004001, NULL, 1,
 8000, -- 总金额80元（单位：分）
 1, -- 状态：已支付
 '阿司匹林肠溶片100mg*30片 + 阿托伐他汀钙片20mg*14片',
 NOW(), NOW(), 0);

-- 为就诊中的病历（4002）创建处方（待支付）
INSERT INTO prescription VALUES
(2043000000000005002, 2043000000000004002, NULL, 1,
 3500, -- 总金额35元（单位：分）
 0, -- 状态：待支付
 '酒石酸美托洛尔片25mg*20片',
 NOW(), NOW(), 0);
...
(2043000000000006001, 2043000000000005001, 1, -- drug_id=1 阿司匹林
 3000, -- 单价30元（分）
 1, -- 数量1盒
 '口服，每次100mg，每日1次',
 NOW(), NOW(), 0),
(2043000000000006002, 2043000000000005001, 2, -- drug_id=2 阿托伐他汀
 5000, -- 单价50元（分）
 1, -- 数量1盒
 '口服，每次20mg，每晚1次',
 NOW(), NOW(), 0);
...
-- 处方5002的药品明细
INSERT INTO prescription_item VALUES
(2043000000000006003, 2043000000000005002, 7, -- drug_id=7 布洛芬缓释胶囊
3500, -- 单价35元（分）
1, -- 数量1盒
'口服，每次0.3g，每日2次',
NOW(), NOW(), 0);
...
(2043000000000007001, 2043000000000003002, 0, 5, 1, '患者扫码报到', NOW(), NOW(), 0);

-- 挂号3003的状态变更：已预约→已报到→就诊中
INSERT INTO registration_status_log VALUES
(2043000000000007002, 2043000000000003003, 0, 5, 1, '患者扫码报到', NOW(), NOW(), 0),
(2043000000000007003, 2043000000000003003, 5, 6, 2, '医生开始接诊', NOW(), NOW(), 0);

-- 挂号3004的状态变更：已预约→已报到→就诊中→已就诊
INSERT INTO registration_status_log VALUES
(2043000000000007004, 2043000000000003004, 0, 5, 1, '患者扫码报到', NOW(), NOW(), 0),
(2043000000000007005, 2043000000000003004, 5, 6, 2, '医生开始接诊', NOW(), NOW(), 0),
(2043000000000007006, 2043000000000003004, 6, 2, 2, '医生结束接诊', NOW(), NOW(), 0);
...
(2043000000000008001, 1, 2, '2026-07-22 09:00:00', '2026-07-22 12:00:00', '门诊接诊', NOW(), NOW(), 0);

-- 诊室2（心内科门诊2）2026-07-22 下午被李娜医生占用
INSERT INTO consultation_room_status VALUES
(2043000000000008002, 2, 2, '2026-07-22 14:00:00', '2026-07-22 17:00:00', '门诊接诊', NOW(), NOW(), 0);
...
(2043000000000009001, 1, 2, 1, '医生您好，我想咨询心悸的问题', 'text', NULL, NOW(), NOW(), 0),
(2043000000000009002, 2, 1, 2, '您好，心悸多久了？有没有伴随其他症状？', 'text', NULL, NOW(), NOW(), 0),
(2043000000000009003, 1, 2, 1, '大概一周了，晚上比较明显', 'text', NULL, NOW(), NOW(), 0);
