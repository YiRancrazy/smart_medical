...
public class MinIOUtil {
     ...
     * @throws Exception
     */
    public String getPresignedObjectUrlOnExpire(String bucketName, String objectName, Integer expires) throws Exception {
        GetPresignedObjectUrlArgs args = GetPresignedObjectUrlArgs.builder()
                .bucket(bucketName)
                .object(objectName)
                .method(Method.GET)
    ...
    public static Long getFolderSize(String bucketName, String folderName) {
        long size = 0;
        try {
            ListObjectsArgs listObjectsArgs = ListObjectsArgs.builder()
                    .bucket(bucketName)
                  .prefix(folderName) // 设置文件夹前缀
               .recursive(true)   // 如果需要递归查找子文件夹中的文件，设置为 true
                    .build();
            ...
            throw new RuntimeException("Error occurred while calculating folder size", e);
        }
        return size;
    }
}
