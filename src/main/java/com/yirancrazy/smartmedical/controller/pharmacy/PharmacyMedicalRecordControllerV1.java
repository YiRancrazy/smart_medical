 ...
 * @Description: 药师查看历史病历记录
 * @Datetime: 2026-07-25 20:25
 * @Version: 1.0
 */

@RestController
@RequestMapping("/api/pharmacy/v1/medical-record")
@Tag(name = "药师端 - 病历历史")
@RequiredArgsConstructor
public class PharmacyMedicalRecordControllerV1 {
